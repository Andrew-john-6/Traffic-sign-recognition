...
#READING THE CSV FILE FOR ADDING THE LABEL
...
plt.bar(range(0, num_classes), numOfSamples)
...
pickle_out= open("model_trained43.p", "wb") #MODEL_TRAINED43  WILL BE UNPICKLED IN TRAIN.PY SO THAT WE CAN USE THE TRAINED MODEL FOR PREDICTING :)

pickle.dump(model,pickle_out)
pickle_out.close()

#MAKE SURE YOU CLOSE THE PICKLE FILE ILLANA SO SAVING!
